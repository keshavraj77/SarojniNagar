package com.example.sarojininagar.Activities;
...
import com.example.sarojininagar.NetworkSync.CheckInternetConnection;
import com.example.sarojininagar.ProductsCategory.BagsActivity;
import com.example.sarojininagar.ProductsCategory.ClothActivity;
import com.example.sarojininagar.ProductsCategory.ShoesActivity;
import com.example.sarojininagar.R;
import com.example.sarojininagar.UserSession.UserSession;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void inflateImageSlider() {
        ...
        slideModels.add(new SlideModel("https://m.media-amazon.com/images/G/31/img19/Wireless/Apple/iPhone11/RiverImages/11Pro/IN_iPhone11Pro_DESKTOP_01._CB437064827_.jpg", null));
        slideModels.add(new SlideModel("https://piunikaweb.com/wp-content/uploads/2019/08/oneplus_7_pro_5g_experience_the_power_of_5g_banner-750x354.jpg", null));
        slideModels.add(new SlideModel("https://lh3.googleusercontent.com/RSyeouwiFX4XVq6iw3H94al0VcXD693tBy2MxhBKCxAHCIfIpdt7wDV47_j2HanPSnTli7JgZ0fYHxESjz0uvVgeCBT3=w1000", null));
        slideModels.add(new SlideModel("https://cdn.metrobrands.com/mochi/media/images/content/Homepage/HOTTMARZZ-BANNER-MOCHI.webp", null));
        slideModels.add(new SlideModel("https://i.pinimg.com/originals/b2/78/7c/b2787cea792bff7d2c33e26ada6436bb.jpg", null));
        slideModels.add(new SlideModel("https://cdnb.artstation.com/p/assets/images/images/016/802/459/large/shuja-shuaib-banner.jpg?1553535424", null));
