package com.example.sarojininagar.ProductsCategory;
...
import com.example.sarojininagar.Activities.CartActivity;
import com.example.sarojininagar.Activities.IndividualProductActivity;
import com.example.sarojininagar.Models.GenericProductModel;
...
public class BagsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = firebaseFirestore.collection("Products").document("103").collection("Bags");
        ...
        adapter =new FirestoreRecyclerAdapter<GenericProductModel, ShoesActivity.MovieViewHolder>(response) {
            @Override
            protected void onBindViewHolder(@NonNull ShoesActivity.MovieViewHolder viewHolder, final int position, @NonNull GenericProductModel model) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(BagsActivity.this, IndividualProductActivity.class);
            ...
            @NonNull
            @Override
            public ShoesActivity.MovieViewHolder onCreateViewHolder(@NonNull ViewGroup group, int viewType) {
                Log.d(TAG,"Inflating Layout");
                View view = LayoutInflater.from(group.getContext())
                        .inflate(R.layout.cards_cardview_layout, group, false);

                return new ShoesActivity.MovieViewHolder(view);
            }
    ...
    public void viewCart(View view) {
        startActivity(new Intent(BagsActivity.this, CartActivity.class));
        finish();
    }
