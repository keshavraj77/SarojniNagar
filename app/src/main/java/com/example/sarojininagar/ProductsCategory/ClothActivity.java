...
public class ClothActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = firebaseFirestore.collection("Products").document("102").collection("Cloths");
            ...
            protected void onBindViewHolder(@NonNull MovieViewHolder viewHolder, final int position, @NonNull GenericProductModel model) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(ClothActivity.this, IndividualProductActivity.class);
    ...
    public void viewCart(View view) {
        startActivity(new Intent(ClothActivity.this, CartActivity.class));
        finish();
    }
